...
export class UserService {
  ...
  private userSource = new BehaviorSubject<UserModel>(
    {'isLogged': false, 'user': {'fullname': null, 'id':null,'UserName':null, isWriter:false}, 'token':{access_token:null, expires_in:null, refresh_token:null, token_type: null}, follows: null, writer:{articles:null, followers:null} }
  );
  ...
  clearUser(){    
    this.userSource.next({'isLogged': false, 'user': {'fullname': null, 'id':null,'UserName':null, isWriter:false}, 'token':{access_token:null, expires_in:null, refresh_token:null, token_type: null}, follows:null, writer:{articles:null, followers:null} });
  }
  clearStoredUser(){
